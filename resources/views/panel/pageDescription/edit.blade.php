        ...
        <div class="form__body">
            <div class="form-control">
                ...
                <div class="form-control__body">
                    <input id="title" type="text" class="form-control__input input" name="title" value="{{$pageDescription['title']}}" placeholder="Заголовок">
                    ...
                    <div class="media-file__body">
                        ...
                        <div data-media-list class="media-file__list">
                            @if($pageDescription['photo'])
                                <div data-media-item="{{$pageDescription['photo']}}" class="media-file-item">
                                    <input data-media-input="" type="text" name="photo" value="{{$pageDescription['photo']}}" class="media-file-item__input">
                                    <span data-media-delete="" class="media-file-item__btn top">Удалить</span>
                                    <img src="{{$pageDescription['photo_url']}}" alt="" class="media-file-item__content">
                                    <span data-look="{{$pageDescription['photo_url']}}" data-look-type="img" class="media-file-item__btn bottom">Просмотр</span>
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="form-control">
                ...
                <div class="form-control__group">
                    <div class="checkbox">
                        ...
                        <input id="display1" type="radio" class="input" name="is_display" value="1" @checked($pageDescription['is_display'] == 1)>
                    </div>
                    <div class="checkbox">

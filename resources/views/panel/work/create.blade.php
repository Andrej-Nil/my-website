...
@section('content')
    <h1 class="panel-title">Создание примера работы</h1>
    @if($errors->any())
    ...
    <form action="{{route('panel.works.store')}}" method="post" class="form">
        @csrf
        ...
        <div class="form-control">
            ...
            <div class="form-control">
                ...
                <div class="form-control__body">
                    <input id="postTitle" type="text" class="form-control__input input" name="url" value="{{old('url')}}" placeholder="Ссылка">
                    @error('title')<p class="form-control__error">{{$message}}</p>@enderror
                </div>
            </div>

...
@section('content')
    <div class="content-top">
        <div class="breadcrumbs">
            ...
            <a class="breadcrumbs-link">
                <span class="breadcrumbs-link__label">Добовить работу</span>
            </a>
        </div>
    </div>
    ...
    <form id="formCreate" action="{{route('panel.portfolios.store')}}" enctype="multipart/form-data" method="post" class="form">
        @csrf
        ...
        <div class="form-control">
            ...
            <div class="form-control__body">
                <input id="link" type="text" class="form-control__input input" name="link" value="{{old('link')}}" placeholder="Ссылка">

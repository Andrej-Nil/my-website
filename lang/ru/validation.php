...
return [
    ...
    */
    ...
    "accepted_if" =>
        "Вы должны принять :attribute, когда :other содержит :value.",
    "active_url" =>
        "Значение поля :attribute должно быть действительным URL адресом.",
    ...
    "between.array" =>
        "Количество элементов в поле :attribute должно быть от :min до :max.",
    "between.file" =>
        "Размер файла в поле :attribute должен быть от :min до :max Кб.",
    "between.numeric" =>
        "Значение поля :attribute должно быть от :min до :max.",
    "between.string" =>
        "Количество символов в поле :attribute должно быть от :min до :max.",
    ...
    "date_format" =>
        "Значение поля :attribute должно соответствовать формату даты: :format.",
    "decimal" =>
        "Значение поля :attribute должно содержать :decimal цифр десятичных разрядов.",
    "declined" => "Значение поля :attribute должно быть отклонено.",
    "declined_if" =>
        "Значение поля :attribute должно быть отклонено, когда :other содержит :value.",
    "different" => "Значения полей :attribute и :other должны различаться.",
    "digits" =>
        "Количество символов в поле :attribute должно быть равным :digits.",
    "digits_between" =>
        "Количество символов в поле :attribute должно быть от :min до :max.",
    "dimensions" =>
        "Изображение, указанное в поле :attribute, имеет недопустимые размеры.",
    ...
    "ends_with" =>
        "Значение поля :attribute должно заканчиваться одним из следующих: :values",
    "enum" => "Значение поля :attribute отсутствует в списке разрешённых.",
    "exists" => "Значение поля :attribute не существует.",
    "extensions" =>
        "Файл в поле :attribute должен иметь одно из следующих расширений: :values.",
    ...
    "gt.file" =>
        "Размер файла, указанный в поле :attribute, должен быть больше :value Кб.",
    ...
    "gte.file" =>
        "Размер файла, указанный в поле :attribute, должен быть :value Кб или больше.",
    ...
    "hex_color" =>
        "Значение поля :attribute должно быть корректным цветом в HEX формате.",
    ...
    "lt.file" =>
        "Размер файла, указанный в поле :attribute, должен быть меньше :value Кб.",
    ...
    "lte.file" =>
        "Размер файла, указанный в поле :attribute, должен быть :value Кб или меньше.",
    "lte.numeric" =>
        "Значение поля :attribute должно быть равным или меньше :value.",
    "lte.string" =>
    ...
    "max.file" =>
        "Размер файла в поле :attribute не может быть больше :max Кб.",
    ...
    "max_digits" =>
        "Значение поля :attribute не должно содержать больше :max цифр.",
    "mimes" =>
    ...
    "min.file" =>
        "Размер файла, указанный в поле :attribute, должен быть не меньше :min Кб.",
    ...
    "min_digits" =>
        "Значение поля :attribute должно содержать не меньше :min цифр.",
    "missing" => "Значение поля :attribute должно отсутствовать.",
    "missing_if" =>
        "Значение поля :attribute должно отсутствовать, когда :other содержит :value.",
    "missing_unless" =>
        "Значение поля :attribute должно отсутствовать, когда :other не содержит :value.",
    "missing_with" =>
        "Значение поля :attribute должно отсутствовать, если :values указано.",
    "missing_with_all" =>
    ...
    "present_if" =>
        "Значение поля :attribute должно быть когда :other содержит :value.",
    "present_unless" =>
        "Значение поля :attribute должно быть, если только :other не содержит :value.",
    "present_with" =>
        "Значение поля :attribute должно быть когда одно из :values присутствуют.",
    "present_with_all" =>
        "Значение поля :attribute должно быть когда все из значений присутствуют: :values.",
    "previous" => "&laquo; Назад",
    "prohibited" => "Значение поля :attribute запрещено.",
    "prohibited_if" =>
        "Значение поля :attribute запрещено, когда :other содержит :value.",
    "prohibited_unless" =>
    ...
    "relatable" =>
        "Значение поля :attribute не может быть связано с этим ресурсом.",
    "required" => "Поле :attribute обязательно.",
    "required_array_keys" =>
        "Массив, указанный в поле :attribute, обязательно должен иметь ключи: :values",
    "required_if" =>
        "Поле :attribute обязательно для заполнения, когда :other содержит :value.",
    "required_if_accepted" =>
        "Поле :attribute обязательно, когда :other принято.",
    "required_if_declined" =>
        "Поле :attribute обязательно, когда :other отклонено.",
    "required_unless" =>
        "Поле :attribute обязательно для заполнения, когда :other не содержит :values.",
    "required_with" =>
    ...
    "size.file" =>
        "Размер файла, указанный в поле :attribute, должен быть равен :size Кб.",
    ...
    "url" =>
        "Значение поля :attribute не является ссылкой или имеет некорректный формат.",
